...
from resummino_parse import parse
...
for v in ["lo","nlo","nlo+nll"]:
	axs[0].plot([0.1,1,10],[get(d,v,0.1,0.1),get(d,v,1,1),get(d,v,10,10)],label=v)
	axs[1].plot([10,1,.10],[get(d,v,10,10),get(d,v,1,10),get(d,v,.1,10)])
	axs[2].plot([10,1,.10],[get(d,v,0.1,10),get(d,v,0.1,1),get(d,v,0.1,.10)])
	axs[3].plot([.10,1,10],[get(d,v,0.1,0.1),get(d,v,1,.1),get(d,v,10,.1)])
	axs[4].plot([.1,1,10], [get(d,v,10,0.1),get(d,v,10,1),get(d,v,10,10)])
