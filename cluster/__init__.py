...
input.set_pre("while [[ $(squeue -u " + user+ " | wc -l) -gt 1998 ]]; do sleep 60; done && sbatch --job-name=" +os.path.basename(sys.argv[0]) +
" --ntasks-per-node 1 --cpus-per-task 1  --time=03:00:00 --mem=100M --partition normal" +
