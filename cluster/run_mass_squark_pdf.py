    ...
    for lo_pdf,nlo_pdf in [("CT18NLO","CT18NLO"), ("MSHT20nlo_as118","MSHT20nlo_as118"), ("NNPDF40_lo_as_01180","NNPDF40_nlo_as_01180")]:
        for p in [2000002, 1000002]:
            ...
            if not run_plot:
                ...
                hepi.mass_plot(dll, p, "lo_pdf", logy=True, label="lo")
                hepi.mass_plot(dll, p, "nlo_pdf", logy=True, label="nlo")
                hepi.mass_plot(dll, p, "nlo_plus_nll_pdf", logy=True, label="nlo+nll")

                plt.savefig(input.get_output_dir() + "mass_pdf_" + str(p) + "_" + str(nlo_pdf) + ".pdf")
    #wait()